Prediction Model using qPCR data (field)
========================================================
...
# train/test data
train_data <- subset(log_norm_ct_field, samplelist_field$model_set=="train")
test_data <- subset(log_norm_ct_field, samplelist_field$model_set=="test")

# train/test info
train_info <- subset(samplelist_field, samplelist_field$model_set=="train")
test_info <- subset(samplelist_field, samplelist_field$model_set=="test")
```
...
all_data <- subset(log_norm_ct_field, !samplelist_field$model_set=="NA")
all_info <- subset (samplelist_field, !samplelist_field$model_set=="NA")

# all control samples (ohne NA -> 3 Kutlivare)
all_data_control <- subset(log_norm_ct_field, samplelist_field$treatment=="control" & !samplelist_field$model_set=="NA")
all_info_control <- subset (samplelist_field, samplelist_field$treatment=="control" & !samplelist_field$model_set=="NA")
```
...
write.table(importance(rf_cat2_train), "../output/importance_field_rf_cat2_train.txt", sep="\t")
...
write.table(importance(rf_cat3_train), "../output/importance_field_rf_cat3_train.txt", sep="\t")
...
rf_cat3_train_vs
# 18
write.table(rf_cat3_train_vs$selected.vars, "../output/field_rf_cat3_train_selected_vars.txt", sep="\t")
...
write.table(importance(rf_cat3_train_control), "../output/importance_field_rf_cat3_train_control.txt", sep="\t")
...
write.table(importance(rf_cat3_all), "../output/importance_field_rf_cat3_all.txt", sep="\t")
...
rf_cat3_all_vs
# 36
write.table(rf_cat3_all_vs$selected.vars, "../output/field_rf_cat3_all_selected_vars.txt", sep="\t")
...
write.table(importance(rf_cat3_all_control), "../output/importance_field_rf_cat3_all_control.txt", sep="\t")
...
write.table(importance_rf_reg, "../output/field_importance_rf_reg.txt", sep="\t")
write.table(importance_rf_cat3, "../output/field_importance_rf_cat3.txt", sep="\t")
```
