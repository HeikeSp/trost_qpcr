...
```{r Load qPCR data and samplelist}
# TROST + Breeder data
...
## Define TROST FIELD train/test info
```{r define TROST FIELD train/test info}
# join metadata
head(tolerance)
...
## Define all TROST FIELD sample information (without 3 cultivars --> model_set=="NA") and subset of all TROST FIELD control samples
```{r define all TROST FIELD sample information (control)}
...
* ``log_norm_ct_woNA_all``: rownames contain ordered sampleIDs, colnames are DMT IDs
* field subset: ``log_norm_ct_trost_field_woNA``
...
* breeder subset: ``log_norm_ct_breeder_woNA``
...
rf_all_pred_breeder_2011 <- predict(rf_all, all_data_woNA_2011)
rf_all_pred_breeder_2012 <- predict(rf_all, all_data_woNA_2012)
...
# 2011/12
cor.test(all_info_2011$mdrym_fve, rf_all_pred_breeder_2011)$estimate # 0.45
cor.test(all_info_2012$mdrym_fve, rf_all_pred_breeder_2012)$estimate # 0.68
# Norika 2011/2012
...
lasso_all_pred_breeder_2011 <- predict(lasso_cv_all, new = as.matrix(all_data_woNA_2011), s = "lambda.min")
lasso_all_pred_breeder_2012 <- predict(lasso_cv_all, new = as.matrix(all_data_woNA_2012), s = "lambda.min")
...
# 2011/12
cor.test(all_info_2011$mdrym_fve, lasso_all_pred_breeder_2011)$estimate # 0.55
cor.test(all_info_2012$mdrym_fve, lasso_all_pred_breeder_2012)$estimate # 0.66
