...
```{r rpart reg train}
input_train <- cbind(train_data, "tol"=train_info$mdrym_gh)
...
pdf("../figures/pot_tree_train_pruned.pdf", width=13, height=8)
...
input_train_control <- as.data.frame( cbind(train_data_control, "tol"=train_info_control$mdrym_gh))
...
pdf("../figures/pot_tree_train_control_pruned.pdf", width=13, height=8)
...
```{r rpart reg all}
input_all <- cbind(all_data, "tol"=all_info$mdrym_gh)
sum(is.na(all_data))
# 80
...
input_all_control <- cbind(all_data_control, "tol"=all_info_control$mdrym_gh)
...
```{r rpart cat2 train}
input_cat2_train <- as.data.frame( cbind(train_data, "tol"=train_info$tol_cat2_gh))
...
```{r rpart cat3 train}
input_cat3_train <- as.data.frame( cbind(train_data, "tol"=train_info$tol_cat3_gh))
...
```{r rpart cat3 all}
input_cat3_all <- as.data.frame( cbind(all_data, "tol"=all_info$tol_cat3_gh))
...
```{r rf reg train}
input_train_woNA <- as.data.frame( cbind(train_data_woNA, "tol"=train_info$mdrym_gh))
...
input_train_control_woNA <- as.data.frame( cbind(train_data_control_woNA, "tol"=train_info_control$mdrym_gh))
...
### random forest regression: train data
```{r rf reg all}
input_all_woNA <- as.data.frame( cbind(all_data_woNA, "tol"=all_info$mdrym_gh))
...
input_all_control_woNA <- as.data.frame( cbind(all_data_control_woNA, "tol"=all_info_control$mdrym_gh))
...
```{r rf cat2 train}
input_cat2_train_woNA <- as.data.frame( cbind(train_data_woNA, "tol"=train_info$tol_cat2_gh))
...
write.table(importance(rf_cat2_train), "../output/importance_pot_rf_cat2_train.txt", sep="\t")
...
```{r rf cat3 train}
input_cat3_train_woNA <- as.data.frame( cbind(train_data_woNA, "tol"=train_info$tol_cat3_gh))
...
write.table(importance(rf_cat3_train), "../output/importance_pot_rf_cat3_train.txt", sep="\t")
...
rf_cat3_train_vs
# 7
write.table(rf_cat3_train_vs$selected.vars, "../output/pot_rf_cat3_train_selected_vars.txt", sep="\t")
...
input_train_cat3_woNA_vs <- as.data.frame( cbind(train_data_woNA_vs, "tol"=train_info$tol_cat3_gh))
...
input_cat3_train_control_woNA <- as.data.frame( cbind(train_data_control_woNA, "tol"=train_info_control$tol_cat3_gh))
...
write.table(importance(rf_cat3_train_control), "../output/importance_pot_rf_cat3_train_control.txt", sep="\t")
...
```{r rf cat3 all}
input_cat3_all_woNA <- as.data.frame( cbind(all_data_woNA, "tol"=all_info$tol_cat3_gh))
...
write.table(importance(rf_cat3_all), "../output/importance_pot_rf_cat3_all.txt", sep="\t")
...
rf_cat3_all_vs
# 18
write.table(rf_cat3_all_vs$selected.vars, "../output/pot_rf_cat3_all_selected_vars.txt", sep="\t")
...
input_cat3_all_control_woNA <- as.data.frame( cbind(all_data_control_woNA, "tol"=all_info_control$tol_cat3_gh))
...
write.table(importance(rf_cat3_all_control), "../output/importance_pot_rf_cat3_all_control.txt", sep="\t")
...
write.table(importance_rf_reg, "../output/pot_importance_rf_reg.txt", sep="\t")
write.table(importance_rf_cat3, "../output/pot_importance_rf_cat3.txt", sep="\t")
```
...
input_cat3_train_woNA_field <- as.data.frame( cbind(train_data_woNA, "tol"=train_info$tol_cat3_fve))
...
write.table(importance(rf_cat3_train_field), "../output/importance_greenhouse_rf_cat3_train_field_tol.txt", sep="\t")
```
...
input_train_cat3_woNA_vs_field <- as.data.frame( cbind(train_data_woNA_vs_field, "tol"=train_info$tol_cat3_fve))
...
#write.table(importance(rf_cat3_train_reduced_field), "../output/importance_rf_cat3_train_reduced_field.txt", sep="\t")
...
```{r pls all}
input_all_woNA <- as.data.frame( cbind(train_data_woNA, "tol"=train_info$mdrym_gh))
...
test_data_woNA_2 <- as.data.frame( cbind(test_data_woNA, "tol"=test_info$mdrym_gh))
