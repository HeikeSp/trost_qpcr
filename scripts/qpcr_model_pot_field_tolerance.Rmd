---
title: "Prediction Model using qPCR data (TROST greenhouse)"
...
# Regression tree: rpart pacakage
...
pdf("figures/model/pot_tree_train_pruned_field_tol.pdf", width=13, height=8)
...
pdf("figures/model/pot_tree_train_control_pruned_field_tol.pdf", width=13, height=8)
...
write.table(importance(rf_cat2_train), "output/model/importance_pot_rf_cat2_train_field_tol.txt", sep="\t")
...
write.table(importance(rf_cat3_train), "output/model/importance_pot_rf_cat3_train_field_tol.txt", sep="\t")
...
rf_cat3_train_vs
# 7
write.table(rf_cat3_train_vs$selected.vars, "output/model/pot_rf_cat3_train_selected_vars_field_tol.txt", sep="\t")
...
write.table(importance(rf_cat3_train_reduced), "output/model/importance_rf_cat3_train_reduced_field_tol.txt", sep="\t")
par(mfrow=c(1,2))
...
write.table(importance(rf_cat3_train_control), "output/model/importance_pot_rf_cat3_train_control_field_tol.txt", sep="\t")
...
write.table(importance(rf_cat3_all), "output/model/importance_pot_rf_cat3_all_field_tol.txt", sep="\t")
...
rf_cat3_all_vs
# 18
write.table(rf_cat3_all_vs$selected.vars, "output/model/pot_rf_cat3_all_selected_vars_field_tol.txt", sep="\t")
...
write.table(importance(rf_cat3_all_control), "output/model/importance_pot_rf_cat3_all_control_field_tol.txt", sep="\t")
...
write.table(importance_rf_reg, "output/model/pot_importance_rf_reg_field_tol.txt", sep="\t")
write.table(importance_rf_cat3, "output/model/pot_importance_rf_cat3_field_tol.txt", sep="\t")
```
